...
import 'emergencysupport.dart'; // Import the EmergencySupportPage
        ...
        child: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.vertical(
                bottom: Radius.circular(30)), // Set the bottom radius
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                // Navigate to Emergency Support screen
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => EmergencySupportPage(),
                  ),
                );
              },
            ),
